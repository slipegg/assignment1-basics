...
def run_swiglu(
    ...
    swiglu.load_state_dict(state_dict, strict=True)
...
def run_multihead_self_attention(
    ...
    """
    mha = MultiheadSelfAttention(d_model=d_model, num_heads=num_heads, is_use_rope=False)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    mha = MultiheadSelfAttention(d_model=d_model, num_heads=num_heads, is_use_rope=True, max_seq_len=max_seq_len, theta=theta)
    mha.q_proj.weight.data = q_proj_weight
    mha.k_proj.weight.data = k_proj_weight
    mha.v_proj.weight.data = v_proj_weight
    mha.output_proj.weight.data = o_proj_weight
...
def run_transformer_lm(
    ...
    """
    transformer_lm = TransformerLM(vocab_size=vocab_size, context_length=context_length, num_layers=num_layers, d_model=d_model, num_heads=num_heads, d_ff=d_ff, theta=rope_theta)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return learning_rate_schedule(it, warmup_steps=warmup_iters, max_lr=max_learning_rate, min_lr=min_learning_rate, cosine_steps=cosine_cycle_iters)
